...
A: Я думаю такие результаты, так как мы картируем не на весь геном, а только на 1 хромосому
```
...
Данные ChIP-seq эксперимента из ENCODE для выбранной гистоновой метки(H2AFZ) согласуется с выданной картинкой

<p float="left">
  <img src="/pictures/result.png" width="400" />
  <img src="/pictures/result2.png" width="400" />
</p>
